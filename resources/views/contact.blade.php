...
@section('contenu')
    ...
    <div class="container">
        <div class="row card text-white bg-dark">
            <h4 class="card-header">Rendez-vous</h4>
            <div class="card-body">
                <form  method="POST">
                    @csrf
...
<script src="https://cdn.jotfor.ms//common/timezonePicker.js" type="text/javascript"></script>
<script src="https://cdn.jotfor.ms/static/prototype.forms.js" type="text/javascript"></script>
<script src="https://cdn.jotfor.ms/static/jotform.forms.js?3.3.26544" type="text/javascript"></script>
<script type="text/javascript">
	JotForm.init(function(){
	/*INIT-START*/
if (window.JotForm && JotForm.accessible) $('input_4').setAttribute('tabindex',0);
      setTimeout(function() {
          $('input_24').hint('prénom@gmail.com');
       }, 20);
   ...
   JotForm.prepareCalculationsOnTheFly([null,null,{"name":"submitForm","qid":"2","text":"Prendre un rendez-vous","type":"control_button"},null,{"name":"nomComplet","qid":"4","text":"Nom complet ","type":"control_textbox"},null,null,null,null,{"name":"dateDe","qid":"9","text":"Date de naissance","type":"control_birthdate"},{"name":"avezvousDeja10","qid":"10","text":"Avez-vous deja consulte ce medecin ?","type":"control_radio"},null,{"name":"typeDe","qid":"12","text":"Type de rendez-vous","type":"control_head"},null,{"name":"selectionnezVotre14","qid":"14","text":"Selectionnez votre specialiste","type":"control_checkbox"},null,null,null,null,{"name":"formulaireDe","qid":"19","text":"Formulaire de prise de rendez-vous medecin traitant","type":"control_head"},{"name":"adresse","qid":"20","text":"Adresse","type":"control_address"},null,{"name":"sexe","qid":"22","text":"Sexe","type":"control_dropdown"},{"name":"numeroDe","qid":"23","text":"Numero de telephone","type":"control_phone"},{"name":"adresseEmail","qid":"24","text":"Adresse email ","type":"control_email"},{"name":"rendezvous","qid":"25","text":"Rendez-vous ","type":"control_appointment"},null,{"name":"pourQui27","qid":"27","text":"Pour qui prenez-vous ce rendez-vous ?","type":"control_checkbox"},{"name":"avezvousLa","qid":"28","text":"Avez-vous la carte vitale","type":"control_radio"}]);
   setTimeout(function() {
JotForm.paymentExtrasOnTheFly([null,null,{"name":"submitForm","qid":"2","text":"Prendre un rendez-vous","type":"control_button"},null,{"name":"nomComplet","qid":"4","text":"Nom complet ","type":"control_textbox"},null,null,null,null,{"name":"dateDe","qid":"9","text":"Date de naissance","type":"control_birthdate"},{"name":"avezvousDeja10","qid":"10","text":"Avez-vous deja consulte ce medecin ?","type":"control_radio"},null,{"name":"typeDe","qid":"12","text":"Type de rendez-vous","type":"control_head"},null,{"name":"selectionnezVotre14","qid":"14","text":"Selectionnez votre specialiste","type":"control_checkbox"},null,null,null,null,{"name":"formulaireDe","qid":"19","text":"Formulaire de prise de rendez-vous medecin traitant","type":"control_head"},{"name":"adresse","qid":"20","text":"Adresse","type":"control_address"},null,{"name":"sexe","qid":"22","text":"Sexe","type":"control_dropdown"},{"name":"numeroDe","qid":"23","text":"Numero de telephone","type":"control_phone"},{"name":"adresseEmail","qid":"24","text":"Adresse email ","type":"control_email"},{"name":"rendezvous","qid":"25","text":"Rendez-vous ","type":"control_appointment"},null,{"name":"pourQui27","qid":"27","text":"Pour qui prenez-vous ce rendez-vous ?","type":"control_checkbox"},{"name":"avezvousLa","qid":"28","text":"Avez-vous la carte vitale","type":"control_radio"}]);}, 20); 
</script>
<link href="https://cdn.jotfor.ms/static/formCss.css?3.3.26544" rel="stylesheet" type="text/css" />
<link type="text/css" rel="stylesheet" href="https://cdn.jotfor.ms/css/styles/nova.css?3.3.26544" />
<style type="text/css">@media print{.form-section{display:inline!important}.form-pagebreak{display:none!important}.form-section-closed{height:auto!important}.page-section{position:initial!important}}</style>
<link type="text/css" rel="stylesheet" href="https://cdn.jotfor.ms/css/styles/payment/payment_feature.css?3.3.26544" />
<style type="text/css">
    .form-label-left{
        width:150px;
    }
...
<link type="text/css" rel="stylesheet" href="https://cdn.jotfor.ms/css/styles/buttons/form-submit-button-big_square_blue.css?3.3.26544"/>
<form class="jotform-form" action="https://submit.jotform.com/submit/212036774509861/" method="post" name="form_212036774509861" id="212036774509861" accept-charset="utf-8" autocomplete="on">
  <input type="hidden" name="formID" value="212036774509861" />
    ...
    <ul class="form-section page-section">
        ...
        <div class="form-header-group  header-default">
          <div class="header-text httal htvam">
            ...
            <div id="subHeader_19" class="form-subHeader">
              Remplissez le formulaire ci-dessous en indiquant le type de rendez-vous dont vous avez besoin. Nous vous recontacterons bientôt pour de plus amples informations.
            </div>
          </div>
        </div>
      </li>
      <li class="form-line" data-type="control_checkbox" id="id_27">
        <label class="form-label form-label-left form-label-auto" id="label_27" for="input_27"> Pour qui prenez-vous ce rendez-vous ? </label>
        <div id="cid_27" class="form-input">
          <div class="form-single-column" role="group" aria-labelledby="label_27" data-component="checkbox">
            <span class="form-checkbox-item" style="clear:left">
              ...
              <input type="checkbox" aria-describedby="label_27" class="form-checkbox" id="input_27_0" name="q27_pourQui27[]" value="Moi même" />
              <label id="label_input_27_0" for="input_27_0"> Moi même </label>
            </span>
            <span class="form-checkbox-item" style="clear:left">
              <span class="dragger-item">
              </span>
              <input type="checkbox" aria-describedby="label_27" class="form-checkbox" id="input_27_1" name="q27_pourQui27[]" value="Un proche" />
              <label id="label_input_27_1" for="input_27_1"> Un proche </label>
            </span>
          </div>
        </div>
      </li>
      <li class="form-line jf-required" data-type="control_textbox" id="id_4">
        ...
        <div id="cid_4" class="form-input jf-required">
          <input type="text" id="input_4" name="q4_nomComplet" data-type="input-textbox" class="form-textbox validate[required]" size="30" value="" placeholder=" " data-component="textbox" aria-labelledby="label_4" required="" />
        </div>
      </li>
      <li class="form-line jf-required" data-type="control_dropdown" id="id_22">
        ...
        <div id="cid_22" class="form-input jf-required">
          <select class="form-dropdown validate[required]" id="input_22" name="q22_sexe" style="width:150px" data-component="dropdown" required="">
            <option value="">  </option>
      ...
      <li class="form-line" data-type="control_phone" id="id_23">
        <label class="form-label form-label-left form-label-auto" id="label_23" for="input_23_area"> Numéro de téléphone </label>
        <div id="cid_23" class="form-input">
          <div data-wrapper-react="true">
            <span class="form-sub-label-container" style="vertical-align:top" data-input-type="areaCode">
              <input type="tel" id="input_23_area" name="q23_numeroDe[area]" class="form-textbox" value="" data-component="areaCode" aria-labelledby="label_23 sublabel_23_area" />
              <span class="phone-separate" aria-hidden="true">
                 -
              </span>
              <label class="form-sub-label" for="input_23_area" id="sublabel_23_area" style="min-height:13px" aria-hidden="false"> Indicatif </label>
            </span>
            <span class="form-sub-label-container" style="vertical-align:top" data-input-type="phone">
              <input type="tel" id="input_23_phone" name="q23_numeroDe[phone]" class="form-textbox" value="" data-component="phone" aria-labelledby="label_23 sublabel_23_phone" />
              <label class="form-sub-label" for="input_23_phone" id="sublabel_23_phone" style="min-height:13px" aria-hidden="false"> Numéro </label>
            </span>
          </div>
        </div>
      </li>
        ...
        <div id="cid_9" class="form-input jf-required">
          <div data-wrapper-react="true">
            <span class="form-sub-label-container" style="vertical-align:top">
              <select name="q9_dateDe[day]" id="input_9_day" class="form-dropdown validate[required]" data-component="birthdate-day" aria-labelledby="label_9 sublabel_9_day">
                <option>  </option>
            ...
            <span class="form-sub-label-container" style="vertical-align:top">
              <select name="q9_dateDe[month]" id="input_9_month" class="form-dropdown validate[required]" data-component="birthdate-month" aria-labelledby="label_9 sublabel_9_month">
                <option>  </option>
            ...
            <span class="form-sub-label-container" style="vertical-align:top">
              <select name="q9_dateDe[year]" id="input_9_year" class="form-dropdown validate[required]" data-component="birthdate-year" aria-labelledby="label_9 sublabel_9_year">
                <option>  </option>
              ...
              <label class="form-sub-label" for="input_9_year" id="sublabel_9_year" style="min-height:13px" aria-hidden="false"> Year </label>
            </span>
          </div>
        </div>
      </li>
          ...
          <div summary="" class="form-address-table jsTest-addressField">
            <div class="form-address-line-wrapper jsTest-address-line-wrapperField">
              <span class="form-address-line form-address-street-line jsTest-address-lineField">
                <span class="form-sub-label-container" style="vertical-align:top">
                  <input type="text" id="input_20_addr_line1" name="q20_adresse[addr_line1]" class="form-textbox validate[required] form-address-line" value="" data-component="address_line_1" aria-labelledby="label_20 sublabel_20_addr_line1" required="" />
                  <label class="form-sub-label" for="input_20_addr_line1" id="sublabel_20_addr_line1" style="min-height:13px" aria-hidden="false"> Adresse </label>
                </span>
              </span>
            </div>
            <div class="form-address-line-wrapper jsTest-address-line-wrapperField" style="display:none">
              <span class="form-address-line form-address-street-line jsTest-address-lineField">
                <span class="form-sub-label-container" style="vertical-align:top">
                  <input type="text" id="input_20_addr_line2" name="q20_adresse[addr_line2]" class="form-textbox form-address-line" value="" data-component="address_line_2" aria-labelledby="label_20 sublabel_20_addr_line2" />
                  <label class="form-sub-label" for="input_20_addr_line2" id="sublabel_20_addr_line2" style="min-height:13px" aria-hidden="false"> Adresse complémenaitre </label>
                </span>
              </span>
            </div>
            <div class="form-address-line-wrapper jsTest-address-line-wrapperField">
              <span class="form-address-line form-address-city-line jsTest-address-lineField ">
                <span class="form-sub-label-container" style="vertical-align:top">
                  <input type="text" id="input_20_city" name="q20_adresse[city]" class="form-textbox validate[required] form-address-city" value="" data-component="city" aria-labelledby="label_20 sublabel_20_city" required="" />
                  <label class="form-sub-label" for="input_20_city" id="sublabel_20_city" style="min-height:13px" aria-hidden="false"> Ville </label>
                </span>
              </span>
              <span class="form-address-line form-address-state-line jsTest-address-lineField form-address-hiddenLine" style="display:none">
                <span class="form-sub-label-container" style="vertical-align:top">
                  <input type="text" id="input_20_state" name="q20_adresse[state]" class="form-textbox form-address-state" value="" data-component="state" aria-labelledby="label_20 sublabel_20_state" />
                  <label class="form-sub-label" for="input_20_state" id="sublabel_20_state" style="min-height:13px" aria-hidden="false"> Département </label>
                </span>
              </span>
            </div>
            <div class="form-address-line-wrapper jsTest-address-line-wrapperField">
              <span class="form-address-line form-address-zip-line jsTest-address-lineField ">
                <span class="form-sub-label-container" style="vertical-align:top">
                  <input type="text" id="input_20_postal" name="q20_adresse[postal]" class="form-textbox validate[required] form-address-postal" value="" data-component="zip" aria-labelledby="label_20 sublabel_20_postal" required="" />
                  <label class="form-sub-label" for="input_20_postal" id="sublabel_20_postal" style="min-height:13px" aria-hidden="false"> Code postal </label>
                </span>
              </span>
            </div>
          </div>
      ...
      <li class="form-line" data-type="control_email" id="id_24">
        <label class="form-label form-label-left form-label-auto" id="label_24" for="input_24"> Adresse email </label>
        <div id="cid_24" class="form-input">
          <input type="email" id="input_24" name="q24_adresseEmail" class="form-textbox validate[Email]" size="30" value="" placeholder="prénom@gmail.com" data-component="email" aria-labelledby="label_24" />
        </div>
      </li>
      <li class="form-line jf-required" data-type="control_radio" id="id_10">
        <label class="form-label form-label-top" id="label_10" for="input_10">
          Avez-vous déjà consulté ce médecin ?
          <span class="form-required">
            *
          </span>
        </label>
        <div id="cid_10" class="form-input-wide jf-required">
          <div class="form-multiple-column" data-columncount="2" role="group" aria-labelledby="label_10" data-component="radio">
            <span class="form-radio-item">
              ...
              <input type="radio" aria-describedby="label_10" class="form-radio validate[required]" id="input_10_0" name="q10_avezvousDeja10" value="Oui" required="" />
              <label id="label_input_10_0" for="input_10_0"> Oui </label>
            </span>
            <span class="form-radio-item">
              <span class="dragger-item">
              </span>
              <input type="radio" aria-describedby="label_10" class="form-radio validate[required]" id="input_10_1" name="q10_avezvousDeja10" value="Non" required="" />
              <label id="label_input_10_1" for="input_10_1"> Non </label>
            </span>
          </div>
        </div>
      </li>
      <li class="form-line jf-required" data-type="control_radio" id="id_28">
        ...
        <div id="cid_28" class="form-input-wide jf-required">
          <div class="form-multiple-column" data-columncount="2" role="group" aria-labelledby="label_28" data-component="radio">
            <span class="form-radio-item">
              <span class="dragger-item">
              </span>
              <input type="radio" aria-describedby="label_28" class="form-radio validate[required]" id="input_28_0" name="q28_avezvousLa" value="Oui" required="" />
              <label id="label_input_28_0" for="input_28_0"> Oui </label>
            </span>
            <span class="form-radio-item">
              <span class="dragger-item">
              </span>
              <input type="radio" aria-describedby="label_28" class="form-radio validate[required]" id="input_28_1" name="q28_avezvousLa" value="Non" required="" />
              <label id="label_input_28_1" for="input_28_1"> Non </label>
            </span>
          </div>
        </div>
      </li>
        ...
        <div id="cid_14" class="form-input-wide jf-required">
          <div class="form-single-column" role="group" aria-labelledby="label_14" data-component="checkbox">
            <span class="form-checkbox-item" style="clear:left">
              ...
              <input type="checkbox" aria-describedby="label_14" class="form-checkbox validate[required]" id="input_14_0" name="q14_selectionnezVotre14[]" value="ORL" required="" />
              <label id="label_input_14_0" for="input_14_0"> ORL </label>
            </span>
            <span class="form-checkbox-item" style="clear:left">
              <span class="dragger-item">
              </span>
              <input type="checkbox" aria-describedby="label_14" class="form-checkbox validate[required]" id="input_14_1" name="q14_selectionnezVotre14[]" value="Chirurgien-dentiste" required="" />
              <label id="label_input_14_1" for="input_14_1"> Chirurgien-dentiste </label>
            </span>
            <span class="form-checkbox-item" style="clear:left">
              <span class="dragger-item">
              </span>
              <input type="checkbox" aria-describedby="label_14" class="form-checkbox validate[required]" id="input_14_2" name="q14_selectionnezVotre14[]" value="Médecin généraliste" required="" />
              <label id="label_input_14_2" for="input_14_2"> Médecin généraliste </label>
            </span>
            <span class="form-checkbox-item" style="clear:left">
              <span class="dragger-item">
              </span>
              <input type="checkbox" aria-describedby="label_14" class="form-checkbox validate[required]" id="input_14_3" name="q14_selectionnezVotre14[]" value="Pédiatre" required="" />
              <label id="label_input_14_3" for="input_14_3"> Pédiatre </label>
            </span>
            <span class="form-checkbox-item" style="clear:left">
              <span class="dragger-item">
              </span>
              <input type="checkbox" aria-describedby="label_14" class="form-checkbox validate[required]" id="input_14_4" name="q14_selectionnezVotre14[]" value="Gynécologue médical et obstétrique" required="" />
              <label id="label_input_14_4" for="input_14_4"> Gynécologue médical et obstétrique </label>
            </span>
            <span class="form-checkbox-item" style="clear:left">
              <span class="dragger-item">
              </span>
              <input type="checkbox" aria-describedby="label_14" class="form-checkbox validate[required]" id="input_14_5" name="q14_selectionnezVotre14[]" value="Ophtalmologue" required="" />
              <label id="label_input_14_5" for="input_14_5"> Ophtalmologue </label>
            </span>
            <span class="form-checkbox-item" style="clear:left">
              <span class="dragger-item">
              </span>
              <input type="checkbox" aria-describedby="label_14" class="form-checkbox validate[required]" id="input_14_6" name="q14_selectionnezVotre14[]" value="Dermatologue et vénérologue" required="" />
              <label id="label_input_14_6" for="input_14_6"> Dermatologue et vénérologue </label>
            </span>
          </div>
        </div>
      </li>
      <li class="form-line" data-type="control_appointment" id="id_25">
        <label class="form-label form-label-top" id="label_25" for="input_25"> Rendez-vous </label>
        <div id="cid_25" class="form-input-wide">
          <div id="input_25" class="appointmentFieldWrapper jfQuestion-fields">
            <input class="appointmentFieldInput " name="q25_rendezvous[date]" id="input_25_date" />
            <input class="appointmentFieldInput" name="q25_rendezvous[duration]" value="30" id="input_25_duration" />
            <input class="appointmentFieldInput" name="q25_rendezvous[timezone]" value="Europe/Paris (GMT+02:00)" id="input_25_timezone" />
      ...
      <li class="form-line" data-type="control_button" id="id_2">
        <div id="cid_2" class="form-input-wide">
          <div style="text-align:center" data-align="center" class="form-buttons-wrapper form-buttons-center   jsTest-button-wrapperField">
            <button id="input_2" type="submit" class="form-submit-button form-submit-button-big_square_blue submit-button jf-form-buttons jsTest-submitField" data-component="button" data-content="">
  ...
  <input type="hidden" class="simple_spc" id="simple_spc" name="simple_spc" value="212036774509861" />
  <script type="text/javascript">
  var all_spc = document.querySelectorAll("form[id='212036774509861'] .si" + "mple" + "_spc");
for (var i = 0; i < all_spc.length; i++)
{
  all_spc[i].value = "212036774509861-212036774509861";
}
  </script>
  ...
  <div class="formFooter f6">
    <div class="formFooter-wrapper formFooter-leftSide">
      <a href="https://www.jotform.com/?utm_source=formfooter&utm_medium=banner&utm_term=212036774509861&utm_content=jotform_logo&utm_campaign=powered_by_jotform_le" target="_blank" class="formFooter-logoLink"><img class="formFooter-logo" src="https://cdn.jotfor.ms/assets/img/logo/logo-new@1x.png" alt="Jotform Logo"></a>
    </div>
    <div class="formFooter-wrapper formFooter-rightSide">
      <span class="formFooter-text">
        Now create your own JotForm - It's free!
      </span>
      <a class="formFooter-button" href="https://www.jotform.com/?utm_source=formfooter&utm_medium=banner&utm_term=212036774509861&utm_content=jotform_button&utm_campaign=powered_by_jotform_le" target="_blank">Create your own JotForm</a>
    </div>
  </div>
</form>
@endsection